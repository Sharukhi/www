...
summary: 'Tauri serves as a platform, for developing desktop apps that feature a web based interface. It empowers developers to utilize web tools such as HTML, CSS and JavaScript to design applications compatible with Windows, macOS and Linux.'
---
